def preprocessing():
    ...
    df = df.drop(columns=['wbc', 'neutrophils', 'lymphocytes', 'monocytes', 'eosinophils', 'rdw', 'plt', 'mpv', 'pct', 'reticulocytes', 'chloride', 'triglycerides', 'glucose', 'alt', 'cholesterol', 'bun', 'alkphos', 'creatinine', 'potassium', 'amylase', 'ggt', 'bilirubin', 'phosphorus', 'calcium', 'sodium', 'magnesium'])
    
    
    biomarker_columns = df.columns[1:10]
