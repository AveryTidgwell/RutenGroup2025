...
n_bootstraps = 200
kalman = False
output_pdf = '32_day_spacing_kidney.pdf'
...
# ========== BASELINE TRANSFORMATION ==========
data0, df0, biomarker_columns = prepare_spaced_data(df, kalman=kalman)
...
for i in tqdm(range(n_bootstraps), desc="Half-population subsampling"):
    ...
    data, df_half_cleaned, biomarker_columns = prepare_model_data(df_half, kalman=kalman)
